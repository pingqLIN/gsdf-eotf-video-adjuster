...
[總覽](#-總覽) · [快速開始](#-快速開始) · [權限](#-權限與隱私) · [功能](#-功能) · [截圖](#-截圖) · [控制項](#-控制項) · [架構](#-架構) · [開發](#-開發) · [文件](#-文件) · [English](README.md)
...
| **GSDF 前級 Gamma 補償** | 以一般 gamma 觀影基準為起點，再讓 GSDF 層作為可控制的補救通道 |
...
| **先平衡 Gamma** | 使用 Gamma 補償，中央 `0 = gamma 2.2`，左側趨近 `3.0`，右側趨近 `1.0` |
